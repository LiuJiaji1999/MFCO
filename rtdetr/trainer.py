            ...
            for i, batch in pbar:
                ...
                with torch.cuda.amp.autocast(self.amp):
                    ...
                    for layer in [2, 4, 8, 9, 12]:
                        ...
                        if layer in [2, 4, 8, 9]: 
                            # 局部互补性损失
                            patches = F.adaptive_avg_pool2d(feas, (2, 2))  # [12, C, 3, 3]  (比如 2x2 或 3x3)

...
# names = ['exp17', 'exp33', 'exp34','exp35', 'exp32', 'exp24']
...
for exp,label in exp_labels.items():
    ...
    data['metrics/precision(B)'] = data['metrics/precision(B)'].astype(np.float32).replace(np.inf, np.nan)
    data['metrics/precision(B)'] = data['metrics/precision(B)'].fillna(data['metrics/precision(B)'].interpolate())  
    plt.plot(data['metrics/precision(B)'], label=label)
plt.xlabel('epoch')
plt.title('precision')
plt.legend()
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['metrics/recall(B)'], label=label)
plt.xlabel('epoch')
plt.title('recall')
plt.legend()
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['metrics/mAP50(B)'], label=label)
plt.xlabel('epoch')
plt.title('mAP_0.5')
plt.legend()
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['metrics/mAP50-95(B)'], label=label)
plt.xlabel('epoch')
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['train/box_loss'], label=label)
plt.xlabel('epoch')
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['train/dfl_loss'], label=label)
plt.xlabel('epoch')
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['train/cls_loss'], label=label)
plt.xlabel('epoch')
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['val/box_loss'], label=label)
plt.xlabel('epoch')
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['val/dfl_loss'], label=label)
plt.xlabel('epoch')
...
for exp,label in exp_labels.items():
    ...
    plt.plot(data['val/cls_loss'], label=label)
plt.xlabel('epoch')
